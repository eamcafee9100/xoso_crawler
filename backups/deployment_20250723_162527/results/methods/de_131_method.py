...
class De131TwoDigitMethod(BasePredictionMethod):
    """
    Phương pháp 131 Đề 2 số
    ...
    def calculate(self, data: Dict[str, Any]) -> Dict[str, List[str]]:
        ...
        try:
            ...
            logger.error(f"[{self.get_code()}] Lỗi tính 131 đề 2 số: {str(e)}")
            return {'two_digits_special': []}

class De131ThreeDigitMethod(BasePredictionMethod):
    """
    Phương pháp 131 Đề 3 số
    Dự đoán từ giải 2.2 (số thứ 4 và bóng), giải 3.4 (số thứ 1 và bóng), và giải 3.5 (càng đề)
    """
    def get_code(self) -> str:
        return "de131_3d"
    ...
    def calculate(self, data: Dict[str, Any]) -> Dict[str, List[str]]:
        ...
        try:
            ...
            # Càng đề từ giải 3.5: số thứ 3 và bóng
            # Ví dụ: 31239 -> số thứ 3 = 2, bóng là 7
            if len(giai_3_5) >= 3:
                digit_third_cang = giai_3_5[2]
            ...
            logger.error(f"[{self.get_code()}] Lỗi tính 131 đề 3 số: {str(e)}")
            return {'three_digits_special': []}