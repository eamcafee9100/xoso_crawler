...
class De112TwoDigitMethod(BasePredictionMethod):
    """
    Phương pháp 112 Đề 2 số
    Dự đoán từ giải 3.4 (số thứ 3 và bóng) và giải 7.1 (số thứ 1 và bóng)
    """
    ...
    def get_description(self) -> str:
        return "Dự đoán 2 số từ giải 3.4 và giải 7.1"
    
    def calculate(self, data: Dict[str, Any]) -> Dict[str, List[str]]:
        giai_3_4 = data.get('giai_3_4', '')
        giai_7_1 = data.get('giai_7_1', '')
        
        if not giai_3_4 or not giai_7_1:
            logger.warning(f"[{self.get_code()}] Thiếu dữ liệu đầu vào: giai_3_4={giai_3_4}, giai_7_1={giai_7_1}")
        ...
        try:
            ...
            # Số thứ hai từ giải 7.1: số thứ 1 và bóng
            # Ví dụ: 32 -> số thứ 1 = 3 và bóng là 8
            if len(giai_7_1) >= 1:
                digit_first = giai_7_1[0]
            ...
            logger.error(f"[{self.get_code()}] Lỗi tính 112 đề 2 số: {str(e)}")
            return {'two_digits_special': []}

class De112ThreeDigitMethod(BasePredictionMethod):
    """
    Phương pháp 112 Đề 3 số
    Dự đoán từ giải 3.4 (số thứ 3 và bóng), giải 7.1 (số thứ 1 và bóng), và giải 3.5 (càng đề)
    """
    def get_code(self) -> str:
        return "de112_3d"
    ...
    def get_description(self) -> str:
        return "Dự đoán 3 số từ giải 3.4, 7.1 và giải 3.5 (càng đề)"
    ...
    def calculate(self, data: Dict[str, Any]) -> Dict[str, List[str]]:
        ...
        if not giai_3_4 or not giai_7_1 or not giai_3_5:
            logger.warning(f"[{self.get_code()}] Thiếu dữ liệu đầu vào: giai_3_4={giai_3_4}, giai_7_1={giai_7_1}, giai_3_5={giai_3_5}")
        ...
        try:
            ...
            logger.error(f"[{self.get_code()}] Lỗi tính 112 đề 3 số: {str(e)}")
            return {'three_digits_special': []}