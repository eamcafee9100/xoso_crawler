...
class Btl_TN_k3N_37LotoMethod(BasePredictionMethod, BaseMakeResult):
    def get_code(self):
        return "btl_tn_k3n_37"

    def get_name(self):
        return "TN_k3N 37"

    def get_description(self):
        return "Tổng từ giải 5.3.2 và 6.2.2"

    def calculate(self, data):
        return self._make_result(
            data, [("giai_5_3", 1)], [("giai_6_2", 1)], reverse=True
        )

class Btl_TN_k3N_38LotoMethod(BasePredictionMethod, BaseMakeResult):
    def get_code(self):
        return "btl_tn_k3n_38"

    def get_name(self):
        return "TN_k3N 38"

    def get_description(self):
        return "Tổng từ giải 3.5.3 và 3.6.4"

    def calculate(self, data):
        return self._make_result(
            data, [("giai_3_5", 2)], [("giai_3_6", 3)], reverse=True
        )

class Btl_TN_k3N_39LotoMethod(BasePredictionMethod, BaseMakeResult):
    def get_code(self):
        return "btl_tn_k3n_39"

    def get_name(self):
        return "TN_k3N 39"

    def get_description(self):
        return "Tổng từ giải 3.5.3 và 4.3.1"

    def calculate(self, data):
        return self._make_result(
            data, [("giai_3_5", 2)], [("giai_4_3", 0)], reverse=True
        )

class Btl_TN_k3N_40LotoMethod(BasePredictionMethod, BaseMakeResult):
    def get_code(self):
        return "btl_tn_k3n_40"

    def get_name(self):
        return "TN_k3N 40"

    def get_description(self):
        return "Tổng từ giải 5.5.1 và giai_db.5"

    def calculate(self, data):
        return self._make_result(
            data, [("giai_5_5", 0)], [("giai_db", 4)], reverse=True
        )