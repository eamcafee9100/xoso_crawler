// Simple direct solution - just copy this into console
console.log("=== Direct Solution ===");

// 1. Define both functions globally
...
// 2. Remove any existing listeners and add new ones
...
document.querySelectorAll('.number-analysis-btn').forEach((btn, index) => {
...
if (heatmapBtn) {
    ...
    // Add new listener
    document.getElementById('generate-heatmap').addEventListener('click', function(e) {
        e.preventDefault();
...
console.log("✅ Direct solution complete! Both features should work now.");
